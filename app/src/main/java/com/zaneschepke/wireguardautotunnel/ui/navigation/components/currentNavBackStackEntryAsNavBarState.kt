            ...
            when {
                backStackEntry.isCurrentRoute(Route.Main::class) -> {
                    NavBarState(
                        ...
                        topTrailing = null, // Removed TunnelActionBar to eliminate plus button
                        route = Route.Main,
                    )
                }
                ...
                backStackEntry.isCurrentRoute(Route.Vision::class) ->
                    NavBarState(
                        showTop = true,
                        showBottom = true,
                        topTitle = { Text(stringResource(R.string.vision)) },
                        route = Route.Vision,
                    )
